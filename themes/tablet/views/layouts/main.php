...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="container" id="page">
            ...
            <div id="header">
                <div id="logo"><?php echo CHtml::encode(Yii::app()->name) . " (tablet)"; ?></div>
            </div><!-- header -->
                ...
                <?php
                    $this->widget('application.extensions.mbmenu.MbMenu', array(
                        'items' => array(
                            ...
                            array('label' => 'My Cellars', 'url' => array('/cellars/index'), 'visible' => !Yii::app()->user->isGuest),
                            array('label' => 'Cellar Admin', 'items' => array(
