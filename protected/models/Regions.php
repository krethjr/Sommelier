...
class Regions extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'appellations' => array(self::HAS_MANY, 'Appellations', 'region_id'),
			'users' => array(self::HAS_MANY, 'User', 'favorite_region_id'),
		);
	}

        public function getCountryRegion()
        {
            return($this->country . " - " . $this->region_name);
        }
        /**
	...
	public function search()
	{
		...
		$criteria->compare('country',$this->country,true);
                $criteria->order = 'country, region_name';
