...
class FrApiBaseModule extends CWebModule
{
    ...
    /**
     * http or https - all urls generated by this module will have this schema
     * @var type 
     */
    public $schema = 'http';
    ...
    protected function getAuthData()
    {
        ...
        if (in_array('url_token', $this->supportedAuth))
        {
            ...
            {
                $this->authData['token'] = $_REQUEST['token'];
            }
        ...
        //check to see if it the token was sent in the header
        if ($this->authData['token'] == null && in_array('http_x_access_token', $this->supportedAuth))
        {
            $headers = getallheaders();
            if (isset($headers['X-Access-Token']))
            {
                $this->authData['token'] = $headers['X-Access-Token'];
            }
        }
    ...
    /**
     * Returns authentication token that is passed via header or url
     * @return type
     */
    ...
    /**
     * Returns user input (POST/PUT/GET)
     * @return mixed
     */
