...
class FrApiResource extends CFormModel {
    ...
    public function updateModelAttributes() {
        ...
        foreach ($map as $apiAttribute => $activeAttribute) {
            if ($this->isAttributeSafe($apiAttribute) && $model->isAttributeSafe($activeAttribute) &&
    ...
    {
        // Ignore unsafe attributes
        // because we'll likely always be doing bulk updates and some fields may
        // not be safe
    }
